...
class RNNCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            W_x = tf.get_variable(shape=(self.input_size,self.state_size), initializer=xavier, name='W_x')
            W_h = tf.get_variable(shape=(self.state_size,self.state_size), initializer=xavier, name="W_h")
            b = tf.get_variable(shape=(self.state_size, ), initializer=tf.constant_initializer(0), name='b')
